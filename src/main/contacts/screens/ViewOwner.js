...
const PersonalInformation = ({t, item, type, navigation}) => {
  return (
    <>
      <View
        style={{
        ...
        <TouchableOpacity
          onPress={() => {
            navigation.navigate(
              type === 'OWNER' ? 'CreateOwner' : 'CreateTenant',
              {user: item},
            );
          }}
          activeOpacity={0.5}
...
const ActiveRequests = ({t, item, type}) => {
  return (
    <>
      <View
        style={{
...
const ActiveComplaints = ({t, item, type}) => {
  return (
    <>
      <View
        style={{
...
const ViewOwner = ({navigation, route}) => {
